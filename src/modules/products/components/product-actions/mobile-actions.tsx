  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className="bg-[var(--brand-surface-bg)] flex flex-col gap-y-3 justify-center items-center text-large-regular p-4 h-full w-full border-t border-[var(--brand-border)]"
          ...
          >
            ...
            <div className="w-full flex items-center justify-between gap-x-4">
              ...
              <div className="flex items-center gap-x-2">
                <button
                  type="button"
                  className="w-10 h-10 rounded-md border border-ui-border-base bg-[var(--brand-surface-bg)]"
              ...
              >
                ...
                >
                  <div className="w-full flex justify-end pr-6">
                    <button title="Close"
                      onClick={close}
                      className="bg-[var(--brand-surface-bg)] w-12 h-12 rounded-full text-ui-fg-base flex justify-center items-center"
                      data-testid="close-modal-button"
                    >
                      <X />
                    </button>
                  </div>
                  <div className="bg-[var(--brand-surface-bg)] px-6 py-12">
