    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-[calc(100%+1px)] right-0 bg-[var(--brand-surface-bg)] border-x border-b border-[var(--brand-border)] w-[420px] text-ui-fg-base"
              ...
              <>
                ...
                <div className="p-4 flex flex-col gap-y-4 text-small-regular">
                  ...
                  <LocalizedClientLink href="/cart" passHref>
                    <Button
                      className="w-full bg-[var(--brand-primary)] after:hidden hover:bg-[var(--brand-primary-hover)]"
                      size="large"
