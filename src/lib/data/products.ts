...
export const listProducts = async ({
  ...
  pageParam?: number
  queryParams?: HttpTypes.FindParams & HttpTypes.StoreProductParams & {expand?: string, handle?:string | string[]}
  countryCode?: string
  regionId?: string
}): Promise<{
...
export const listBundles = async ({
  ...
  response: { products: BundleProduct[]; count: number }
  nextPage: number | null
  queryParams?: HttpTypes.FindParams & HttpTypes.StoreProductParams
}> => {
  if (!countryCode && !regionId) {
  ...
  return sdk.client
    .fetch<{ bundle_products: BundleProduct[]; count: number }>(
